...
def obtener_datos():
    nombre = "Juan"
    edad = 30
    return nombre, edad  # Devuelve ambos valores como una tupla (nombre, edad)

# Al recibir múltiples valores, podemos desempaquetarlos en varias variables.
info = obtener_datos()
print(f"Info recibida: {info[0]}, {info[1]}")  # Imprime: "Info recibida: ('Juan', 30)"
...
def calcular_promedio(lista_numeros):
    ...
    return f"{suma_total / cantidad:.2f}"

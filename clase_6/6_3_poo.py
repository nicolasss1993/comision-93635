...
# gato_1 = Gato("Nico") # A esto se le dice instanciar el objeto
# gato_3 = Gato("Jose", 10)
# gato_1.maullear()
# gato_3.info()
# gato_1.caminar()
...
class Vehiculo: # Mayuscula siempre al comienzo
...
mi_auto = Vehiculo("Toyota", "Corolla", 2022, "Negro") # Instancia = Crear un objeto
...
class Producto:
    ...
    def get_precio(self):
        ...
        #     return "Codigo incorrecto, no se muestra el precio"

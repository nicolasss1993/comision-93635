...
# except ZeroDivisionError: # Forma de declarar 1 solo error
#     print("Error: No se puede dividir por cero.")
# except (ValueError, ZeroDivisionError): # Forma de declarar 2 o mas errores
#     print("Error: Debes introducir un número válido.")
# except Exception as e: # si no se que error pueda ocurrir, uso Exception.
#     print(f"Paso algo del estilo: {e}")
...
a = 5
b = 10
print(f"La suma de {a} + {b} es:", a * b)  # El código intenta sumar, pero en su lugar multiplica.

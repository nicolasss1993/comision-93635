...
------------------------------------------
    ...
    if condicion:
        ...
        # Código a ejecutar si la otra condición es falso
    elif condicion:
        ...
    elif condicion:
        ...
...
lista = []
for numero in range(5): # range(5) --- [0, 1, 2, 3, 4] / numero = 4
...
while continuar == "s":
    ...
    continuar = input("¿Desea continuar? (s/n): ")[0].lower()
print(lista_nombres)
# # """
# # Conclusión
# # ==========

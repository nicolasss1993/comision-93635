...
for i in range(1,10): # [lista de numeros]
    print(i)
...
for i in range(len(numeros)): # range(5) - 
    numeros[i] *= 2 # es lo mismo que numeros[i] = numeros[i] * 2
print("Lista modificada:", numeros)

# # 5. Uso de la Función enumerate
print("\nEjemplo 5: Uso de enumerate para obtener índice y valor")
frutas = ["manzana", "plátano", "cereza"]
for indice, fruta in enumerate(frutas): # --- [("0", "manzana"), ("1", "platano"), ("2","cereza")]
    print(f"Índice: {indice}, Fruta: {fruta}")

# # 6. Modificar Elementos con enumerate
print("\nEjemplo 6: Modificar elementos con enumerate")
for indice, fruta in enumerate(frutas): # frutas = [(0, "MANZANA"), (1,"PLATANO"), (2, "cereza")]
    frutas[indice] = fruta.upper() # frutas[1] = platano.upper()
...
for key, value in calificaciones.items(): # dicts_items[("matematicas", 90), ...()]
    print(f"{key}: {value}")

...
# # != : diferente de / a es diferente de b
# # >  : mayor que
# # <  : menor que
# # >= : mayor o igual que
# # <= : menor o igual que
...
# a = 4 y b = 5
# if a > 2 and b > 4: --- Entonces Python ejecuta el codigo del if porque ambas son True
# a = 2 y b = 6 --- False and True --- Entonces Python no ejecuta el codigo.


# # or  : devuelve True si al menos una condición es verdadera.
# if a > 2 and b > 4: --- Entonces Python ejecuta el codigo del if porque ambas son True
# a = 2 y b = 6 --- False and True --- Entonces Python si ejecuta el codigo.
# # not : invierte el valor de una condición.
# a = 4 ... if a = 5: Python no ejecuta el codigo. if not a = 5: Python si ejecuta el codigo.
# # Sentencia If
# # ============

...
3. Privados:
   ...
   - Python aplica "name mangling" (_NombreClase__atributo),
     lo que dificulta el acceso directo desde fuera de la clase. Persona.__dni = "32741382" - Error
...
class Persona:
    ...
    def edad(self):
        ...
        #print("Viendo la edad")
        if validacion is True:
            return self._edad
        return "No tenes permisos para ver este dato"
